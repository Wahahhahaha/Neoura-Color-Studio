...
<head>
    ...
    <title>403 | {{ $website['name'] ?? 'Neora Color Studio' }}</title>
...
<main class="error-shell">
    <div class="error-card error-card-elegant fade-in visible">
        ...
        <p class="error-text">Sorry, this page is only available to authorized users of {{ $website['name'] ?? 'Neora Color Studio' }}.</p>
